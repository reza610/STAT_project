...
#US total
All_Data %>% ggplot(aes(Date, sqrt(Recorded.music.and.music.subscriptions), fill = X7.Day.Avg.New.Cases.per.100K)) + geom_bar(stat = "identity") + scale_fill_gradient2(low = "white", high = "red") + theme(axis.text.x = element_text(angle = 90)) + labs(title = "Prices in the United States Over Time", x = "Date", y = "Prices", fill = "7 Day New Case Average") 

All_Data %>% ggplot(aes(X7.Day.Avg.New.Cases.per.100K, Recorded.music.and.music.subscriptions)) + geom_point() + geom_abline(aes(intercept=2.62e+02, slope = 1.47e-01))


#Alaska total
All_Data %>% ggplot(aes(Date, sqrt(Recorded.music.and.music.subscriptions), fill = X7.Day.Avg.New.Cases.per.100K)) + geom_bar(stat = "identity") + scale_fill_gradient2(low = "white", high = "red") + theme(axis.text.x = element_text(angle = 90)) + labs(title = "Prices in Alaska Over Time", x = "Date", y = "Prices", fill = "7 Day New Case Average") 

All_Data %>% ggplot(aes(X7.Day.Avg.New.Cases.per.100K, Recorded.music.and.music.subscriptions)) + geom_point() + geom_abline(aes(intercept=2.3e+02, slope = 2.93e-02))


#Finland total
All_Data %>% ggplot(aes(Date, sqrt(Recorded.music.and.music.subscriptions), fill = X7.Day.Avg.New.Cases.per.100K)) + geom_bar(stat = "identity") + scale_fill_gradient2(low = "white", high = "red") + theme(axis.text.x = element_text(angle = 90)) + labs(title = "Prices in Finland Over Time", x = "Date", y = "Prices", fill = "7 Day New Case Average") 

All_Data %>% ggplot(aes(X7.Day.Avg.New.Cases.per.100K, Recorded.music.and.music.subscriptions)) + geom_point() + geom_abline(aes(intercept=1.05e+02, slope = 6.57e-04))
