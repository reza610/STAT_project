...
```{r}
#Video rental
All_Data %>% ggplot(aes(Date, sqrt(Rental.of.video.discs.and.other.media), fill = X7.Day.Avg.New.Cases.per.100K)) + geom_bar(stat = "identity") + scale_fill_gradient2(low = "white", high = "red") + theme(axis.text.x = element_text(angle = 90)) + labs(title = "Video Rental and Streaming Prices Over Time", x = "Date", y = "CPI", fill = "7 Day New Case Average") 
...
#Cleaning Products
All_Data %>% ggplot(aes(Date, sqrt(Household.cleaning.products), fill = X7.Day.Avg.New.Cases.per.100K)) + geom_bar(stat = "identity") + scale_fill_gradient2(low = "white", high = "red") + theme(axis.text.x = element_text(angle = 90)) + labs(title = "Cleaning Product Prices Over Time", x = "Date", y = "CPI", fill = "7 Day New Case Average") 
...
#Rent
All_Data %>% ggplot(aes(Date, sqrt(Rent.of.primary.residence), fill = X7.Day.Avg.New.Cases.per.100K)) + geom_bar(stat = "identity") + scale_fill_gradient2(low = "white", high = "red") + theme(axis.text.x = element_text(angle = 90)) + labs(title = "Rent Prices Over Time", x = "Date", y = "CPI", fill = "7 Day New Case Average") 
...
All_Data %>% ggplot(aes(Date, sqrt(Nonprescription.drugs), fill = X7.Day.Avg.New.Cases.per.100K)) + geom_bar(stat = "identity") + scale_fill_gradient2(low = "white", high = "red") + theme(axis.text.x = element_text(angle = 90)) + labs(title = "Nonprescription Drug Prices Over Time", x = "Date", y = "CPI", fill = "7 Day New Case Average") 
...
#Prescription Drugs
All_Data %>% ggplot(aes(Date, sqrt(Prescription.drugs), fill = X7.Day.Avg.New.Cases.per.100K)) + geom_bar(stat = "identity") + scale_fill_gradient2(low = "white", high = "red") + theme(axis.text.x = element_text(angle = 90)) + labs(title = "Prescription Drug Prices Over Time", x = "Date", y = "CPI", fill = "7 Day New Case Average") 
...
#Music
All_Data %>% ggplot(aes(Date, sqrt(Recorded.music.and.music.subscriptions), fill = X7.Day.Avg.New.Cases.per.100K)) + geom_bar(stat = "identity") + scale_fill_gradient2(low = "white", high = "red") + theme(axis.text.x = element_text(angle = 90)) + labs(title = "Physical and Digital Music Prices Over Time", x = "Date", y = "CPI", fill = "7 Day New Case Average") 
...
#US total
All_Data %>% ggplot(aes(Date, sqrt(All.items), fill = X7.Day.Avg.New.Cases.per.100K)) + geom_bar(stat = "identity") + scale_fill_gradient2(low = "white", high = "red") + theme(axis.text.x = element_text(angle = 90)) + labs(title = "Prices in the United States Over Time", x = "Date", y = "CPI", fill = "7 Day New Case Average") 
...
#Alaska total
Alaska_data %>% ggplot(aes(Date, sqrt(All.Items), fill = Total_Cases)) + geom_bar(stat = "identity") + scale_fill_gradient2(low = "white", high = "red") + theme(axis.text.x = element_text(angle = 90)) + labs(title = "Prices in Alaska Over Time", x = "Date", y = "CPI", fill = "New Cases") 
...
#Finland total
Finland_data %>% ggplot(aes(Date, sqrt(Point.figure), fill = New_cases)) + geom_bar(stat = "identity") + scale_fill_gradient2(low = "white", high = "red") + theme(axis.text.x = element_text(angle = 90)) + labs(title = "Prices in Finland Over Time", x = "Date", y = "CPI", fill = "New Cases") 
