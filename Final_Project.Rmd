...
All_Data %>% ggplot(aes(X7.Day.Avg.New.Cases.per.100K, Rental.of.video.discs.and.other.media)) + geom_point() + geom_abline(aes(intercept=1.370e+02, slope = 4.443e-02))
...
All_Data %>% ggplot(aes(X7.Day.Avg.New.Cases.per.100K, Household.cleaning.products)) + geom_point() + geom_abline(aes(intercept=124.58675, slope = 0.07743))
...
All_Data %>% ggplot(aes(X7.Day.Avg.New.Cases.per.100K, Rent.of.primary.residence)) + geom_point() + geom_abline(aes(intercept=3.43e+02, slope = 1.18e-01))
...
All_Data %>% ggplot(aes(X7.Day.Avg.New.Cases.per.100K, Nonprescription.drugs)) + geom_point() + geom_abline(aes(intercept=96.2208276, slope = -0.0002892))
...
All_Data %>% ggplot(aes(X7.Day.Avg.New.Cases.per.100K, Prescription.drugs)) + geom_point() + geom_abline(aes(intercept=526.89029, slope = 1.22e-02))
...
All_Data %>% ggplot(aes(X7.Day.Avg.New.Cases.per.100K, Recorded.music.and.music.subscriptions)) + geom_point() + geom_abline(aes(intercept=7.97e+01, slope = -2.43e-03))
...
All_Data %>% ggplot(aes(X7.Day.Avg.New.Cases.per.100K, All.items)) + geom_point() + geom_abline(aes(intercept=2.62e+02, slope = 1.47e-01))
...
Alaska_data %>% ggplot(aes(Total_Cases, All.Items)) + geom_point() + geom_abline(aes(intercept=2.3e+02, slope = 2.93e-02))
...
Finland_data %>% ggplot(aes(New_cases, Point.figure)) + geom_point() + geom_abline(aes(intercept=1.05e+02, slope = 6.57e-04))
